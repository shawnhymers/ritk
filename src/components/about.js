...
return(
  <>
    ...
    <div style ={{overflowX:'hidden'}}>
      ...
      <Row className = 'roaming-white vertical-padding-md centered-children'>
      ...
      <Col xs={6} sm={6} md={6} lg={6} xl={6}>
        ...
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>We’re a twenty-something married couple who met when we were 18 in our university residence. Alia was studying photography and wanted to move to New York City and be a fashion photographer, Shawn was studying aerospace engineering and wanted to adopt a husky and build a cabin in the woods. After 6 months of being in the same friend group, this unlikely duo fell for each other and found out they actually had a ton of similarities. After 5 years together, once we had finished our degrees, we decided to have a small 8 person wedding and say ‘I do’ to forever. Our post-degree interests each changed a few times over by the time we got married, and we began working in our respective fields unsure of what the future held.</p>

        <p className = 'roaming-yellow-text roaming-text-md centered-text '>Why we started traveling:</p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>Our travel bug started when we were planning our honeymoon back in 2019. Both of us having just finished university and gotten married, we finally began thinking about where in the world we would like to go. We began watching youtube videos, found amazing travel vloggers, began reading Conde Nast Traveler, and admired many travel blogs. Suddenly our list of potential honeymoon destinations grew a couple pages long. The travel bug bit us hard. </p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>Since we only had a short period of time during the Christmas holidays we decided to go to Mexico City and Cancun because we wanted some sunshine and some tacos without a long travel day… who doesn’t? </p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>We promised ourselves that our honeymoon in Mexico was the beginning of prioritizing travel in our life and decided that we would save up and backpack Europe in the summer of 2020. </p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>Well, we all know what happened in 2020…and safe to say all of our travel dreams got put on hold. Instead, we moved across the country and began living in Vancouver, BC. We fell in love with hiking, biking, and the outdoors. We became more conscious of the climate crisis and decided to become vegan. While our days in Vancouver were incredible, and we did get to do lots of local travel, our travel bug intensified with time. </p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>In the summer of 2021, we sat on a picnic blanket looking out to Vancouver’s False Creek and rewrote a list of all the places we wanted to travel. The list looked a bit different from 2 years prior, but one thing that stayed the same was that it was several pages long. Our potential trips we wanted to make once the pandemic was behind us grew longer as the sun disappeared behind the mountains. We spent more evenings in the park revisiting the list until it morphed into a massive five-year timeline with 15 separate trips planned.</p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>We realized that our list did not fit into any of our budgets: financial, time off, or carbon footprint. Our environmental impact has always been important to us, but it had become even more so since our move to Vancouver. We wondered if it was possible to travel while keeping our carbon footprint in mind, and that’s when we realized that traveling full-time could be the way to do it.</p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>Since Shawn was working remotely already, and Alia is a freelance photographer, we realized now was a good time in our life to consider full-time travel. Safe to say, it did not take long to convince ourselves that we could make it work. </p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>A few months later, we sold 75% of our things, packed up our Vancouver apartment, and booked a one way flight to Nicaragua with a rough plan to try and make it down to Peru or Bolivia. </p>

        <p className = 'roaming-yellow-text roaming-text-md centered-text'>Traveling carbon-consciously:</p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>Before we began traveling, we decided to make our best effort to travel at or below the footprint of the average Canadian. We had no idea if this was possible or not, but it was a challenge we wanted to take on. </p>
        <p className = 'roaming-black-text roaming-text-sm vertical-padding-sm'>Our plan of action on how to do this would include the following:</p>
