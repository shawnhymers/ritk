  ...
  <>
    <Row>
      ...
      <Col xs={4} sm={4} md={4} lg={4} xl={4} className ='centered-children' style = {{maxHeight:'4em'}}>
        <Link to='home/main' className = 'centered-children'style = {{textDecoration:'none'}} >
      ...
      <Col xs={2} sm={2} md={2} lg={2} xl={2} className ='centered-children'>
        <Link to='home/social' className = 'centered-children'style = {{textDecoration:'none'}} >
          <p className = 'balloon-text  roaming-yellow-text medium-link-text'>Socials</p>
        </Link>
      </Col>
    </Row>
