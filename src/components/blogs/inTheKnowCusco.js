  ...
  <div style={{overflowX:'hidden'}}>
    ...
    <BlogBody header ={{src:cusco7, label:'In The Know: Cusco'}}
              ...
              contentTest ={[{type:'header',text:"In The Know: Cusco"},
                            ...
                            {type:'listItem',text:"3. Check out Cusco’s local markets: San Pedro Market & San Blas Market. San Pedro is much bigger & offers a huge range of items to browse & purchase."},
                            ...
                            {type:'paragraph',text:"If you want a taste of local life and local food, make sure to check out two of Cusco’s local markets. Not only can you buy a wide range of produce, food, and other goodies, you can learn about Peru’s diverse corn, potatoes, and grains. You can also get a look at some of the herbal and natural remedies Peruvians use to cure ailments. If you go to San Blas Market, check out Govinda Lila, the first vegan restaurant in Lima. Their menu del dia options are super cheap and very filling!"},

                            {type:'listItem',text:"5. Enjoy food or a beverage from the lovely outdoor cafeteria / garden of Cabin & Garden (you can stay at the cabins too along with a resident llama!)"},
                            ...
                            {type:'listItem',text:"6. Do a day trip "},
